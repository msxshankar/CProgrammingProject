...
int main (int argc, char **argv) {
	...
	/*
	 * handles arguments, returning value and printing correct error message
	...
	/* Reads in File using pgmRead.c and .h */
	int returnValue = read(pgmValues, inputFile, argv, PGMB2A);	
	...
	/* Writes to file */
	return(writeConvert (pgmValues, outputFile, argv, returnValue));
